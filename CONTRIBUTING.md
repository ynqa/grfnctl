# Contributing to grfnctl

We welcome contributions to "grfnctl" and greatly appreciate your help in making
...
[grfnctl repository](https://github.com/ynqa/grfnctl) to create a copy of the
...
```bash
git clone https://github.com/<your_username>/grfnctl.git
```
...
[grfnctl Pull Request page](https://github.com/ynqa/grfnctl/pulls) and click the
...
Thank you for considering contributing to "grfnctl"!
